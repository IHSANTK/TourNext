...
exports.loginUser = async (req, res) => {
  try {
    ...
    res.cookie('user_refreshToken', userRefreshToken, { httpOnly: true,  maxAge: 7 * 24 * 60 * 60 * 1000 })
       .cookie('user_accessToken', userAccessToken, { httpOnly: true,  maxAge: 15 * 60 * 1000 })
