...
exports.loginUser = async (req, res) => {
  try {
    ...
    res.cookie('user_refreshToken', userRefreshToken, { httpOnly: true,sameSite: 'Strict', maxAge: 900000  })
       .cookie('user_accessToken', userAccessToken, {  httpOnly: true,sameSite: 'Strict', maxAge: 604800000 })
